...
<link rel="stylesheet" href="css/styles_tema.css">
  ...
  <div id="mySidenav" class="sidenav">
    <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
      <?php
        require './utils/FunTemaA.php';
        $Functions = new FunTema;
        $ExbirConteudos = $Functions->ExibeSideBar($_SESSION['curso_clicado'],$_POST['Btn_assunto']);
...
<?php
  ...
  $ExbirConteudos = $Functions->ExibeMaterial($_POST['Btn_assunto']);
 ?>
