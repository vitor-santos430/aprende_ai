  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <h4 class="nav-item active ml-5">
        <a class="nav-link" href="?page=home">Administrativo Aprende Ai!</a>
      </h4>
      <!--
      <li class="nav-item">
    ...
    <ul class="nav navbar-nav navbar-right mr-5">
      ...
      <li>
          <a class="nav-link" id="nav-link-margin" href="?page=home"> <i class="fas fa-long-arrow-alt-left"></i> Voltar Aprende Aí  </a>
      </li>
