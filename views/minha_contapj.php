...
<form method="post" enctype="multipart/form-data">
    ...
    <h2 class="nome-perfil"><?php echo "$nome <br> $sobrenome"; ?></h2>
    ...
    <div class="formulario">
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" id="validationDefault02" placeholder="Razão Social" value="<?php echo "$sobrenome"; ?>" name="razaoSocial" required>
        </div>

        <div class="form-group col-md-12">
          <label for="inputPassword4">CNPJ</label>
          <input type="text" class="form-control" id="inputPassword4" placeholder="CNPJ (Somente números)" name="cnpj" value="<?php echo "$cnpj"; ?>">
        </div>
